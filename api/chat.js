export default async function handler(req, res) {
  ...
  // Gestione date
  const oggi = new Date().toISOString().split('T')[0]; // Data odierna
  ...
  const prompt = `Sei un esperto news. Oggi è il 21 dicembre 2025. 
                  Analizza i feed caricati: ${contesto}. 
                  Analizza la ricerca web (se presente): ${datiWeb}.
                  Rispondi alla domanda: ${messaggio}.
                  Usa intestazioni H3 per i titoli e elenchi puntati. Sii sintetico.`;
